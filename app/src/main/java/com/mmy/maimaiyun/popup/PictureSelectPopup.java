...
public class PictureSelectPopup extends PopupWindow {
    ...
    public PictureSelectPopup(Activity context, View.OnClickListener itemsOnclick) {
        ...
        bt_takephoto = (Button) mMenuView.findViewById(R.id.bt_select_takephoto);
        bt_photo = (Button) mMenuView.findViewById(R.id.bt_select_photo);
        bt_cancel = (Button) mMenuView.findViewById(R.id.bt_select_cancel);
        //取消按钮
